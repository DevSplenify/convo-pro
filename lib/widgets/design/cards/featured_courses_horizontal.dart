...
class FeaturedCoursesHorizontal extends StatelessWidget {
  final String image;
  final String title;
  ...
  const FeaturedCoursesHorizontal({
    super.key,
    required this.image,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: 213.w,
        padding: EdgeInsets.only(top: 8.h, left: 8.w, right: 8.w, bottom: 15.h),
